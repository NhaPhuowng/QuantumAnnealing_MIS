...
if __name__ == "__main__":
    ...
    output_folder = "PickAnnealingTime/gamma1_AnTime200"
    ...
    for i in range(1, 16):
        ...
        file_to_write = "gamma1_AnTime200_" + str(i) +".json"
    ...
    df.to_csv(os.path.join(output_csv, "gamma1_AnTime200.csv"), index=False)

    print("Data has been saved to gamma1_AnTime200.csv")
